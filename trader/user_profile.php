...
<?php
    ...
    if(isset($_GET['user_profile'])){
        ...
        $user_pass = $row_user['TRADER_PASSWORD'];

        $user_email = $row_user['TRADER_EMAIL'];

        $user_image = $row_user['TRADER_IMAGE'];





        $user_contact = $row_user['TRADER_NUMBER'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="trader_images/<?php echo $admin_image; ?>" alt="<?php echo $admin_name; ?>" width="70" height="70">
...
if(isset($_POST['update'])){
    ...
    if($run_user){
        ...
        echo "<script>alert('Trader has been updated sucessfully')</script>";
        echo "<script>window.open('login.php','_self')</script>";
